...
This is an automated fraud alert from fintech Transaction Monitoring System.<br>
...
EMAIL_FROM = "mtstrading07@gmail.com"
try:
    APP_PASSWORD = dbutils().secrets().get("fintech-scope", "gmail_api_key")
...
def fraud_card_alert_stream():
    ...
    return spark.readStream.table("fintech.gold.fraud_card_alert")